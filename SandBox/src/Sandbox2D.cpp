...
void Sandbox2D::OnUpdate(Hazel::Timestep ts)
{
...

	{
		...
		Hazel::Renderer2D::DrawQuad({ 0.0f, 0.0f, 0.0f }, { 0.5f, 0.5f }, m_SquareColor);
		Hazel::Renderer2D::DrawRotatedQuad({ 1.0f, 2.0f, 0.0f }, { 0.5f, 0.5f }, glm::radians(45.0f), {0.2f, 0.5f, 0.3f, 1.0f});
		Hazel::Renderer2D::DrawQuad({ 0.5f, 0.5f,-0.1f }, { 5.0f,5.0f }, m_Texture, 10.0f);
